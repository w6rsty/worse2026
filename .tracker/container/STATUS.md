...
| **Active task** | (none) |
| **Next up** | **Phase 7** remaining: P7-introsort_tune ← **HERE** (last one). **Done:** P7-stable_sort_buffered (R41), P7-array_trivial_push (R42), P7-default_alloc_fastpath (R43: List push = std, ForwardList push beats std/eastl). **Deferred:** P7-hash_cache (R40: revisit with `Hash<String>`). |
...
- [ ] **Phase 7** — bench-driven perf optimizations (R39 gaps): ~~hash_cache~~ **deferred (R40)**, **stable_sort_buffered ✓ (R41)**, **array_trivial_push ✓ (R42)**, **default_alloc_fastpath ✓ (R43)**, **introsort_tune ← HERE**
