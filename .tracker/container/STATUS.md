...
| **Active task** | (none) |
| **Next up** | **Phase 7** remaining: P7-array_trivial_push (~8×) ← **HERE**, P7-default_alloc_fastpath, P7-introsort_tune. **Done:** P7-stable_sort_buffered (R41: ~72k, beats EASTL). **Deferred:** P7-hash_cache (R40: structural gap, revisit with `Hash<String>`). |
...
- [ ] **Phase 7** — bench-driven perf optimizations (R39 gaps): ~~hash_cache~~ **deferred (R40)**, **stable_sort_buffered ✓ (R41)**, **array_trivial_push ← HERE**, default_alloc_fastpath, introsort_tune
