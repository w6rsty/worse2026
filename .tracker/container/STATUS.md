...
- [ ] **Phase 10** — cleanup/housekeeping (R49): **P10-builtin_wrap ✓** (new `worse.core.intrinsics`, 25 sites, release codegen-neutral), **P10-style_audit ✓** (confirmed clang-format clean, conventions hold), **P10-doxygen_setup ✓** (Doxygen + Awesome CSS v2.4.2; cppm-module filter verified end-to-end, doxygen 1.17.0, 0 warnings, 196 pages), **P10-doc_pass** (focused `/** */`) — *deferred to a follow-up (user-scoped)* *(3/4 done)*
